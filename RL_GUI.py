...
def draw_board(window, grid, iterations, terminal_states, boulder_states, rows, cols):
    max_reward = get_max_reward(terminal_states)
    max_punishment = get_max_punishment(terminal_states)
